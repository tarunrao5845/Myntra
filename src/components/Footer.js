...
export default function Footer() {
  return (
    <div>
      <footer className="py-5 my-5 mx-5">
        <div className="row">
          ...
          <div className="col-6 col-md-2 mb-3 ">
            ...
            <h5>BEST ONLINE SHOPPING SITE IN INDIA</h5>
            <ul className="nav flex-column">
            <li className="nav-item mb-2">
                <a href="/">Smart Clothing</a>
              </li>
              <li className="nav-item mb-2">
                <a href="/">Trendy Clothing</a>
              </li>
              <li className="nav-item mb-2">
                <a href="/">Stylish Acc.</a>
              </li>
              <li className="nav-item mb-2">
                <a href="/">Fun & Folic</a>
              </li>
          ...
          <div className="col-6 col-md-6 mb-3">
            <h5>EXPERIENCE MYNTRA ON MOBILE APP</h5>
            <ul className="nav flex-column">
              <img
